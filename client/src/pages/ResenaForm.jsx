          ...
          <main className="bg-white dark:bg-card-dark rounded-xl shadow-sm border border-[#f4f3f0] dark:border-[#3f3b2e] overflow-hidden">
            ...
            <form className="flex flex-col">
              ...
              <div className="px-6 md:px-8 py-4 pb-6">
                ...
                <div className="relative">
                  <textarea
                    className="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-card-dark text-gray-900 dark:text-white shadow-sm focus:border-primary focus:ring-primary text-sm p-3 resize-none"
