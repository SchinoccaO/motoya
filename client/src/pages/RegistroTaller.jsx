            ...
            <form className="flex flex-col gap-6 p-8 pt-2">
              ...
              <div className="grid gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    className="w-full rounded-lg border border-[#dbdce0] dark:border-[#3a352a] bg-white dark:bg-[#2a261a] px-4 py-3 text-sm text-[#181611] dark:text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-gray-400 resize-none"
